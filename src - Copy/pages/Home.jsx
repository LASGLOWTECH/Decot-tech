...
<Ourservices /> 
      ...
      <section className='  px-6 py-6  md:px-24' id='Building-trust'>
        ...
        <h3 className='md:text-3xl mt-24 text-4xl  text-darkBlue text-center font-medium'>
        Our SymbolicAppearance


        </h3>
        <p className='text-grey-500 text-center font-medium p-4 text-2xl '>What We Represents </p>
