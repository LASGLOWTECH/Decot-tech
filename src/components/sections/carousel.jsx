...
<Carousel  responsive={responsive}
    ...
    >
      <div className="py-6">
        <h1 className="text-5xl md:text-6xl  leading-tight   lg:max-w-3xl lg:leading-tight font-bold  text-white" data-aos-duration="1000" aos-once="false" data-aos="fade-up">
