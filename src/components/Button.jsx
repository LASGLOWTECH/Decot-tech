const Button = ({ children, onClick, type = 'button', className = '', variant = 'default' }) => {
    ...
    const variants = {
        ...
        secondary: ' hidden md:block text-white  hover:shadow-lg hover:shadow-Secondarycolor  bg-gradient-to-r from-Primarycolor  via-Secondarycolor to-Primarycolor hover:text-light font-medium hover:bg-white rounded-lg sm:w-auto w-100  rounded-md px-4 py-3 ',
