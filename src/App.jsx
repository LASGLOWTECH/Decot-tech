...
function App() {
  ...
  return (
    ...
    <main className="min-h-screen p-16  flex items-center justify-center flex-col bg-gradient-to-r from-lightBlue to-darkBlue">
   ...
   <img src="/Digitech.svg"
    ...
    <section className=' flex flex-col items-center justify-center'>
      ...
      <h1 className='text-white text-3xl  md:text-7xl py-6 text-center  shadow-2xl px-3 shadow-white font-extrabold'>We are coming soon</h1>
